    ...
    <div className={`page theme-${current.accent}`}>
      ...
      <main id="top">
        ...
        <section className="section container product-platform">
          ...
          <div className="platform-grid">
            <article className="glass-card platform-card highlight-card">
              ...
              <p>
                Вместо одного шаблонного лендинга КидВест показывает сегментированную подачу — это усиливает восприятие проекта как реального стартапа, а не учебного макета.
              </p>
            </article>
        ...
        <section id="reviews" className="section container">
          <SectionTitle chip="Отзывы" title="Что говорят о КидВест" text="Отзывы встроены как часть живого продукта и помогают преподавателю быстрее поверить в реалистичность идеи." />
